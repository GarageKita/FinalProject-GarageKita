        ...
        <div className="max-w-7xl pt-4 mx-auto px-2 sm:px-6 lg:px-8 bg-white justify-between fixed left-0 right-0">
          <div className="relative flex items-center h-16">
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4 pt-2 pl-4">
                  <Link to="/requests" className=" cursor-pointer font-medium text-gray-500 hover:text-gray-900 mx-4">
                    Browse semua Request
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <Link to="/" className="font-semibold py-2 px-4 text-rust-600 hover:text-rust-400 transition duration-150 ease-in-out" onClick={logout}>
                Log out
              </Link>
            </div>
          </div>
