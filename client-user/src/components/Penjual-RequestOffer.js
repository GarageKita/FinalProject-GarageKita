            ...
            <div className="fixed z-10 inset-0 overflow-y-auto" role="dialog" aria-modal="true">
                <div className="flex min-h-screen text-center md:block md:px-2 lg:px-4" >
                    ...
                    <div className="w-full relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                        <button onClick={() => openRequestToOffer(null)} type="button" className="absolute top-4 right-4 text-gray-400 hover:text-gray-500 sm:top-8 sm:right-6 md:top-6 md:right-6 lg:top-8 lg:right-8">
                        ...
                        <div className="flex flex-col justify-between sm:col-span-8 lg:col-span-7">
                            <div>
                                <h2 className="text-2xl font-bold text-gray-700 sm:pr-12">
                                    <span className="text-2xl font-light">Request: </span>{mockRequests.name}
                                </h2>
                                ...
                                <p className="mt-1 text-xs text-gray-500 font-normal">request dari <span className="font-bold text-rust-600 hover:text-rust-500 hover:underline cursor-pointer">Pembeli #9977</span></p>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-sm font-normal text-gray-500">{mockRequests.description}</p>
                                    </div>
                                    <div className="mt-3">
                                        <p className="text-sm font-bold text-rust-600">Jumlah Request: <span className="text-sm font-normal text-gray-500">{mockRequests.qty}</span></p>
