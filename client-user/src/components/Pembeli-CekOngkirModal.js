            ...
            <React.Fragment>
                ...
                <div className="fixed z-9 inset-0 overflow-y-auto px-80" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <span className="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                        ...
                        <p className="mt-6 mb-4 mx-8 text-left font-semibold text-gray-900 text-2xl">Cek Ongkir & Proses ke MyDeals</p>
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-4">
                                            <div className="flex flex-row justify-between">
                                                <label for="address" className="block text-sm font-medium text-gray-700">Alamat Pengiriman</label>
                                                <a onClick={() => triggerFormModal()} className="text-xs text-teal-600 underline hover:text-teal-700 cursor-pointer">Tambah alamat baru</a>
                                            </div>
                                            <select name="address" id="address" className="mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm sm:text-sm py-2 px-3 border border-solid border-gray-300 rounded-md">
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            <label for="courier" className="block text-sm font-medium text-gray-700">Pilih Kurir</label>
                                            <select name="courier" id="courier" className="mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm sm:text-sm py-2 px-3 border border-solid border-gray-300 rounded-md">
                                                <option>TIKI</option>
                                                <option>JNE</option>
                    ...
                    <div className="bg-white px-4 pt-3 pb-6 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-150 ease-in-out">
                            Terima Harga, masukkan ke MyDeals
                        </button>
