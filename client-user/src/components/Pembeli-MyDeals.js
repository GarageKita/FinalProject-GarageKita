    ...
    return (
        <div>
            <div className="flex flex-row justify-between">
                ...
                <button onClick={() => changeMode('penjual')} className="flex flex-row cursor-pointer max-h-max h-4 text-teal-600 hover:text-teal-400 transition duration-150 ease-in-out">
                                        ...
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                            ...
                                            <p className="ml-4">
                                                <span className="text-sm font-light text-gray-500">
                                                    Jumlah yang kamu bayarkan: 
                                                </span>Rp{deal.deal_price.toLocaleString()}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 flex items-end justify-between text-sm">
                                        <div>
                                            <p className="text-xs text-left font-medium py-1 text-teal-600">
                                                Status: <span className="px-2 inline-flex text-xs leading-5 font-normal rounded-full bg-red-100 text-gray-600">{deal.payment_status} payment</span>
                                            </p>
                                        ...
                                        <div className="flex flex-row">
                                            {(deal.payment_status === 'paid') ?
                                                <button className="bg-blue-500 text-white font-bold py-2 px-4 mr-4 rounded opacity-50 cursor-not-allowed">Sudah Dibayar</button>
                                            :
                                                <button onClick={(e) => handlePayment(e, deal.id, deal.deal_price)} className="text-white bg-teal-600 rounded-md mr-4 px-5 py-3 cursor-pointer hover:bg-teal-700 font-medium transition duration-150 ease-in-out">Bayar Sekarang</button>
                                            }
                                            <button className="text-gray-700 bg-gray-200 rounded-md px-5 py-3 cursor-pointer hover:bg-gray-300 font-normal transition duration-150 ease-in-out">Batalkan</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
