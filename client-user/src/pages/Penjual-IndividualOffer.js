                ...
                <div>
                    ...
                    <main className="pt-10 max-w-7xl mx-auto px-4 lg:px-8">
                        ...
                        <div className="flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                            <h1 className="text-3xl font-extrabold tracking-tight text-rust-700">Mode Pembeli: <span className="font-normal">MyOffers</span></h1>
                                ...
                                <div className="flex flex-col grid-cols-2">
                                    <div className="sm:-mx-6 lg:-mx-8">
                                        ...
                                        <div className="flex flex-row align-top mb-5 h-6 w-60 max-w-max text-rust-600 hover:text-rust-400 cursor-pointer transition duration-150 ease-in-out">
                                            ...
                                            <Link to="/Offers/myOffers" className="mb-3 font-semibold text-lg">Daftar MyOffers saya</Link>
                                        </div>
                                        ...
                                        <section className="flex flex-row ">
                                            ...
                                            <div className="w-full relative flex text-left items-center bg-white pt-14 pb-8  rounded-xl border-gray-200 border border-solid sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                                ...
                                                <div className="aspect-w-2 aspect-h-3 shadow-lg rounded-lg bg-gray-100  sm:col-span-4 lg:col-span-5">
                                                    <img src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone11-red-select-2019?wid=940&hei=1112&fmt=png-alpha&.v=1566956144763" alt="Product shot" className="object-center object-cover" />
                                                </div>
                                                ...
                                                <div className="flex flex-col justify-between sm:col-span-8 lg:col-span-7">
                                                    <div>
                                                        ...
                                                        <section aria-labelledby="information-heading" className="mt-1">
                                                            ...
                                                            <p className="mt-1 text-xs text-gray-500 font-normal">di-request oleh <span className="font-bold text-teal-600 hover:text-teal-500 hover:underline cursor-pointer">Pembeli #1233</span></p>

                                                            <div className="mt-6">
                                                                <p className="text-sm font-bold text-rust-600">Request Description</p>
                                                                <p className="text-sm font-normal text-gray-500">Dicari: kondisi tampilan 80% ke atas, fungsionalitas 100%. Retak bocel sedikit nggak masalah yg penting berfungsi baik seperti baru. Prioritas warna hitam/abu.</p>
                                                            </div>
                                                            ...
                                                            <div className="border-t border-solid border-gray-200 mt-6 pt-2">
                                                                ...
                                                                <div className="mt-3">
                                                                    <p className="text-sm font-bold text-rust-600">Jumlah Offer: <span className="text-sm font-normal text-gray-500">1</span></p>
                                                                </div>
                                                                <div className="mt-3">
                                                                    <p className="text-sm font-bold text-rust-600">Harga Offer: <span className="text-sm font-normal text-gray-500">Rp18000000</span></p>
                                                                </div>
                                                                <div className="mt-3">
                                                                    <p className="text-sm font-bold text-rust-600">Waktu Offer: <span className="text-sm font-normal text-gray-500">{dateFormatter('2021-08-23T13:39:35.534Z')}</span></p>
                                                                </div>
                                                                <div className="mt-3">
                                                                    <p className="text-sm font-bold text-rust-600">Status Offer:
                                                ...
                                                <div>
                                                    <section aria-labelledby="options-heading" >
                                                        <form>
                                                            ...
                                                            <input type="number" className="focus:outline-none focus:ring-1 focus:ring-offset-none focus:ring-rust-500 px-6 py-3 w-full rounded-md border border-solid border-gray-300" placeholder="Offer baru" />
                                                            <button type="submit" className="mt-4 w-full bg-rust-600 border border-transparent rounded-md py-2 px-8 flex items-center justify-center text-sm font-medium text-white hover:bg-rust-700 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rust-500">Submit harga Offer baru</button>
                                                            <p className=" text-center mt-1 text-xs text-gray-500 font-normal">Email notifikasi perubahan harga Offer akan dikirim ke Penjual.</p>
                                                        </form>
                                                    </section>
                                                </div>
                                                ...
                                                <div>
                                                    <section aria-labelledby="options-heading" className="border-t border-solid border-gray-200 pt-4 mt-6" >
                                                        <form>
                                                            ...
                                                            <button type="submit" className="mt-4 w-full bg-gray-300 border border-transparent rounded-md py-2 px-8 flex items-center justify-center text-sm font-medium text-gray-700 hover:bg-gray-200 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rust-500">Hapus Offer</button>
                                                            <p className=" text-center mt-1 text-xs text-gray-500 font-normal">Email notifikasi penghapusan harga Offer akan dikirim ke Penjual.</p>
                                                        </form>
                                                    </section>
                                                </div>
