...
function PenjualAllRequests() {
    ...
    function openRequestToOffer(requestObj) {
    ...
    return (
        <>
            ...
            <RequestOfferModal openRequestToOffer={openRequestToOffer} mockRequests={request} />
            : null
            }
                ...
                <div>
                    ...
                    <main className="pt-10 max-w-7xl mx-auto px-4 lg:px-8">
                        <div className="flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                            <h1 className="text-3xl font-extrabold tracking-tight text-rust-700">Mode Penjual: <span className="font-normal">All Requests</span></h1>
                                                            ...
                                                            <tr key={request.id}>
                                                                <td className="px-2 py-4 leading-3">
                                                                    <div className="flex text-left">
                                                                        <div className="ml-4">
                                                                            <a onClick={() => openRequestToOffer(request)} className="cursor-pointer text-sm font-bold text-rust-600 hover:text-rust-500">
                                                                            {request.name}
                                                                            </a>
                                                                ...
                                                                <td className=" whitespace-nowrap text-center text-sm">
                                                                    <a onClick={() => openRequestToOffer(request)} className="text-white rounded-md bg-rust-600 px-4 py-2 cursor-pointer hover:bg-rust-500 transition duration-150 ease-in-out my-1 font-medium">Berikan Offer</a>
                                                                </td>
                                                            </tr>
