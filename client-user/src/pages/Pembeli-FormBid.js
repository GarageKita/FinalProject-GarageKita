            ...
            <React.Fragment>
                ...
                <div className="fixed z-10 inset-0 overflow-y-auto px-80" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <span className="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                        ...
                        <p className="mt-6 mb-4 mx-8 text-left font-semibold text-gray-900 text-2xl">Edit Bid saya: Jam Tangan Rolex bekas</p>
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="px-8 py-5 bg-white">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="budget" class="block text-sm font-medium text-gray-700">Harga Bid</label>
